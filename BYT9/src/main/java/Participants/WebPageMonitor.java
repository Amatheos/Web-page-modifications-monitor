...
public class WebPageMonitor {
    ...
    private Map<URL, Set<Observer>> _observers;
    ...
    public void addMonitoredPage(URL url) {
        try {
            ...
            _observers.putIfAbsent(url, new HashSet<Observer>());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
     ...
     */
    public void addObserver(URL url, Observer observer) {
     ...
     */
    public void removeObserver(URL url, Observer observer) {
